...
#client.API_URL = 'https://testnet.binance.vision/ws'  # To change endpoint URL for test account
#client.API_URL = 'wss: //testnet.binance.vision/ws'
client.API_URL = 'wss: //testnet.binance.vision/stream'
        ...
        html.Div([
            dcc.Graph(id='figure-1',
                      figure={
                          ...
                          'layout':
                          go.Layout(title="Portfolio Value (USDT)")
                      })
        ],
                 style={
                     'width': '30%',
        ...
        html.Div([
            dcc.Graph(id='figure-2',
                      figure={
                          ...
                          'layout':
                          go.Layout(title="Portfolio Value (BTC)")
                      })
        ],
                 style={
                     'width': '30%',
        ...
        html.Div([
            dcc.Graph(id='figure-4',
                      figure={
                          ...
                          'layout':
                          go.Layout(title="Portfolio Distribution (in USDT)")
                      })
        ],
                 style={
                     'width': '50%',
...
@app.callback(Output('figure-1', 'figure'), Output('figure-2', 'figure'),
              Output('figure-3', 'figure'), Output('figure-4', 'figure'),
...
def update_layout(n):
    ...
    figure5 = {
        ...
        'layout':
        go.Layout(showlegend=False, title="Tokens distribution")
    }
